...
def spoof(target_ip, spoof_gateway_ip):
...
def man_the_middle():
    ...
    try:
        ...
        for target_ip in target_ips:
            process = multiprocessing.Process(target=spoof, args=(target_ip, gateway_ip))
        ...
        for target_ip in target_ips:
            process = multiprocessing.Process(target=restore, args=(gateway_ip, target_ip))
